    ...
    <div class="row"> 
            ...
            <div class="card card-body mainBoxes">
                ...
                <br>
                    ...
                    placeholder="Type Your Witty Username Here!" id="GetName"> 
                <br>
                <br>
                <h5>Themes</h5> 
                ...
                <br>
                    ...
                    placeholder="To change the text color, input a hex value here!" id="GetTextColor"> 
                <br>
                <h5>Box Color</h5>
                <br>
                    <input type="color" class="form-control form-control-lg"
                    placeholder="To change the box background colors, input a hex value here!" id="GetBoxColor"> 
                <br>
                <h5>Background Color</h5>
                <br>
                    <input type="color" class="form-control form-control-lg"
                    placeholder="If you want a different background color, enter a hex value!" id="GetBGColor"> 
                <br>
                <h5>Typing Test Highlight Color</h5>
                <br>
                    <input type="color" class="form-control form-control-lg"
                    placeholder="The highlight color for the current word in a typing test. Again a Hex value!" id="GetHighlight"> 
                <br>
            </div>
            <br>
        </div>
