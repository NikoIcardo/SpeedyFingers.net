    ...
    <nav class="navbar navbar-default navbar-expand-lg navbar-light fixed-top jeb">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active Nav"><a class="nav-link" href = "TextingTest.php">Texting Test (For Phones)</a></li>
            </ul>
        </div>
    </nav>
</header>
        ...
        <div class="col-md-12 mx-auto jeb" style ="border-radius: 8px;">
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <div class="card card-body mainBoxes">
                        <h5>Directions</h5>
                        <p>Welcome to the SpeedyFingers Texting Test. Simply begin typing the above text after clicking the input box and after 1 minute we will give you your wpm.
                        </p>
                        <p id = "log"></p>
                    </div>
                </div>
