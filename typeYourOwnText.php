...
<header>
    <nav class="navbar navbar-default navbar-expand-lg navbar-light fixed-top jeb">
        <a class="logo" id='logo'><img src="img\Logo\SF_logo_white1.png" height="50" width="66" /></a>
...
<main>
    ...
    <div class="container text-left">
        ...
        <button class='btn1 btn' id='button' onclick=hide()> Hide Input Block </button>


        <!--Display and Input-->
        <div class="row">

            <div class="col-md-12 mx-auto jeb" id='Col1' style="border-radius: 8px; margin-bottom: 2rem; margin-top:1rem;">
                <br>
                <div class="card card-body mainBoxes">
                    <h5>Saved Text</h5>
                </div>
                <br>
                <textarea autocapitalize='off' class="form-control form-control-lg" placeholder="Input Your Own Text Here!" id="ownText" rows="5"></textarea>
                <br>
                <div class="card card-body mainBoxes">
                    <h5>Type how many minutes you want to type below</h5>
                </div>
                <br>
                <textarea autocapitalize='off' class="form-control form-control-lg" placeholder="10, .5, 2.5, etc. Default is 1. " id="minutes" rows="1"></textarea>
                <br><br>
            </div>

            <div class="col-md-12 mx-auto jeb" style="border-radius: 8px;  margin-top:1rem;">
                <br>
                ...
                <div class="row mt-5">
                    <div class="col-md-12">
                        <div class="card card-body mainBoxes">
                            <h5>Directions</h5>
                            <p>
                                Welcome to the Type Your Own Text Typing Test. You can enter your own text in the entry area above.
        ...
        <script>
            ...
            function hide() {
                if (hidden === false) {
                    ...
                    document.querySelector('#button').innerHTML = 'Reveal';
                } else {
                    hidden = false;
                    document.querySelector('#Col1').style.display = 'inline';
                    document.querySelector('#button').innerHTML = 'Hide Input Block';
                }
            }
        </script>
</main>
